...
const ModalAddHost = ({handleClose, show }) => {
    ...
    return (
        ...
        <Modal.Title className="text-dark display-6">Adding Host role</Modal.Title>
        </Modal.Header>
        <Modal.Body className='text-dark fw-mediums'>By clicking &apos;Accept&apos;, you will be able to create your own loos that can be used by other users. What are you waiting for? Join now!</Modal.Body>
        <Modal.Footer>
        {
