...
import { fetchChangeStateLooBooking, fetchCreateLooReview, fetchGetMyBookings } from '../../redux/actions/action';

// eslint-disable-next-line react/prop-types
const ModalLooReview = ({ handleClose, show, looId, bookingId}) => {
    ...
    const handleSave = async () => {
        try {
            await dispatch(fetchCreateLooReview(looId, form )).then(() => {
                dispatch(fetchChangeStateLooBooking(bookingId))
            }).then(() => {
